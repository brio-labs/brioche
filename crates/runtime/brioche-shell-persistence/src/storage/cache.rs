//! Two-tier sub-routine cache for visible and recently used session heads.
//!
//! The cache is cohesive because L1/L2 movement is one persistence contract:
//! visible sub-routines are pinned while closed sub-routines obey LRU eviction.
//!
//! Refs: docs/SPECS.md §Book III-B Ch 2.1, I-Persist-Cache
