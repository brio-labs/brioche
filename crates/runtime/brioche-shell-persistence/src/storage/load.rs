//! Full-session loading, lazy hydration, and sub-routine cache lookup helpers.
//!
//! Loading stays out of the Redb transaction module so replay/hydration code can
//! review the read-side contract without save-path noise.
//!
//! Refs: I-Shell-Load-Batch, I-Persist-Cache

use brioche_core::ChatMessage;

use super::{PersistenceError, RedbStorage, SubRoutineCache};
