//! Shell persistence error type and Redb conversions.
//!
//! Keeping the taxonomy in one module makes boundary mapping auditable and
//! prevents storage helpers from inventing local error wrappers.
//!
//! Refs: I-Core-NoPanic
