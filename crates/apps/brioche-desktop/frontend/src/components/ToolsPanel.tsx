						...
						<div className="flex flex-col gap-1.5">
							{items.map((tool) => (
								<div key={tool.id} className="p-3 bg-bg-elevated/30 border border-border rounded-lg flex items-center justify-between gap-4 transition-all hover:border-border-hover">
									...
									<label className="flex items-center gap-2 cursor-pointer text-xs text-fg-secondary select-none shrink-0 py-1 [&_input]:rounded [&_input]:bg-bg-elevated [&_input]:border-border [&_input]:text-accent [&_input]:focus:ring-accent-glow [&_input]:cursor-pointer">
										<input
											type="checkbox"
