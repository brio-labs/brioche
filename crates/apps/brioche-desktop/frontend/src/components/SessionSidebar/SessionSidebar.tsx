		...
		<div className="flex h-full w-full flex-col bg-transparent text-fg-primary">
			...
			<div className="p-3 pb-2">
				<button
					...
					className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-md bg-accent px-3 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-accent-hover active:bg-accent-dim"
				>
			...
			<div className="flex items-center justify-between border-b border-border bg-bg-surface px-4 py-2">
				<span className="text-xs font-semibold text-fg-secondary">Projects</span>
					...
					<PopoverPrimitive.Portal>
						...
						>
							<div className="flex flex-col gap-0.5">
								<span className="px-2 py-1 text-[10px] font-semibold text-fg-muted uppercase tracking-wider">Sort By</span>
								<button
									type="button"
									...
									className={cn(
										...
										sortMode === "date" && "bg-bg-highlight text-fg-primary font-medium"
									)}
								>
									<span className="w-4 flex items-center justify-center">
										{sortMode === "date" && <Check className="h-3.5 w-3.5 text-accent" />}
									</span>
									<span>Date</span>
								</button>
								<button
									...
									className={cn(
										"flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1.5 text-xs text-fg-secondary hover:bg-bg-elevated hover:text-fg-primary",
										sortMode === "name" && "bg-bg-highlight text-fg-primary font-medium"
									)}
								>
									<span className="w-4 flex items-center justify-center">
										{sortMode === "name" && <Check className="h-3.5 w-3.5 text-accent" />}
									</span>
									<span>Name</span>
								</button>
							</div>
