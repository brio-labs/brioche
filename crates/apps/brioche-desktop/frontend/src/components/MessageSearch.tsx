      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {results.map((result, idx) => (
            <div
              key={result.id}
              className={`flex items-start gap-3 px-4 py-4 rounded-sm cursor-pointer transition-all text-text-secondary text-sm hover:bg-accent/10 hover:text-text-primary ${
                idx === selectedIndex
          ...
          {results.length > 0 && (
            <div className="px-4 py-2 text-xs text-text-muted border-t border-border mt-2">
